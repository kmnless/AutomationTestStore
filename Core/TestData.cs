...
public record UserData(
    ...
    string Region,    string LoginName, string Password);

public static class TestData
{
    // Used by UC-1 — one test run per user
    public static IEnumerable<object[]> ValidUsers =>
    [
        [new UserData(
            "John", "Doe", "john.test001@mailinator.com", "1234567890",
            "123 Main St", "New York", "10001", "United States",
            "New York", "jdoe_test001", "Test@12345")],

        [new UserData(
            "Jane", "Smith", "jane.test002@mailinator.com", "0987654321",
            "456 Oak Ave", "Los Angeles", "90001", "United States",
            "California", "jsmith_test002", "Test@67890")]
    ];

    // Used by UC-2 — one test run per invalid value
    public static IEnumerable<object[]> InvalidLogins =>
    [
        ["",                    "empty"],
        ["a",                   "too short (1 char)"],
